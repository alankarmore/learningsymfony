...
use Acme\TestBundle\Entity\Blog;
use Acme\TestBundle\Form\BlogType;
...
class BlogController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('AcmeTestBundle:Blog')->findAll();
     ...
     * @Method("POST")
     * @Template("AcmeTestBundle:Blog:new.html.twig")
     */
    ...
    */
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('AcmeTestBundle:Blog')->find($id);
    ...
    */
     ...
     * @Method("PUT")
     * @Template("AcmeTestBundle:Blog:edit.html.twig")
     */
